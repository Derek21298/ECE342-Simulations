...
grid on;
set(gca, 'fontsize', 20);
% title('Common Source Amplifier Experimental Frequency Response (Unloaded)');
...
grid on;
set(gca, 'fontsize', 20);
% title('Common Source Amplifier Experimental Frequency Response (Loaded)');
ylabel('A_{V} (Loaded Gain), dB');
xlabel('Frequency, Hz');
% ylim([ ]);
% xlim([ ]);
hold on;
...
grid on;
set(gca, 'fontsize', 20);
% title('Common Emitter Amplifier Experimental Frequency Response (Loaded)');
ylabel('A_{V} (Loaded Gain), dB');
xlabel('Frequency, Hz');
% ylim([ ]);
% xlim([ ]);
