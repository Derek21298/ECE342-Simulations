...
plot(Vout, Vgs);
set(gca,'fontsize',20);
title('Voltage Transfer Characteristic when R_{D} = 4.44 k\Omega');
xlabel('V_{I}, Volts');
ylabel('V_{O}, Volts');
grid on;
ylim([-1 6])
...
plot(Vout, Vgs);
set(gca,'fontsize',20);
title('Voltage Transfer Characteristic when R_{D} = 1 k\Omega');
xlabel('V_{I}, Volts');
ylabel('V_{O}, Volts');
grid on;
ylim([-1 6]);
...
plot(Vout, Vgs);
set(gca,'fontsize',20);
title('Voltage Transfer Characteristic when R_{D} = 100 k\Omega');
xlabel('V_{I}, Volts');
ylabel('V_{O}, Volts');
grid on;
ylim([-1 6])
